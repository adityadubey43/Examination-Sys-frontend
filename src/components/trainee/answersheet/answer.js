    ...
    render() {
        ...
        return (
            <div className="answer-table-outer">
                ...
                <div className="answer-table-wrapper container">
                    <button className='download-button' onClick={this.onDownloadCertificate}>Download Certificate</button>
                    <Descriptions bordered title={null} border size="small">
                        ...
                        <Descriptions.Item label="Score">{'we will inform you shortly'}</Descriptions.Item>
                    </Descriptions>
                    <br />
                    <Table
                        size="small"
